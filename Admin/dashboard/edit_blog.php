                  ...
                  <div class="card-body">
                    <form id = "edit_blog_form">
                      ...
                      <div class="mb-3">
                        ...
                        <textarea class="form-control" aria-label="With textarea" placeholder="Comment" id="content" name="content"><?= $result['content']; ?></textarea>

                        <div class="form-text">Min 100 words</div>
                      </div>
                      <div class="mb-3">
                        <label class="form-label" for="basic-icon-default-phone">Tags</label>
                      ...
                      <div class="form-check form-switch mb-2">
                        <?php
                          if($result['show_comments'] == 0){?>
                            <input class="form-check-input" type="checkbox" id="areCommentsAllowed" name = "areCommentsAllowed"/>
                          <?php
                          }
                          else{?>
                            <input class="form-check-input" type="checkbox" id="areCommentsAllowed" name="areCommentsAllowed" checked/>
                          <?php
                          }
                        ?>
...
<script>
  ...
  //delete
  function _delete(){
      deleteItemQuery("database/Blog/delete_blog.php", ".loading", "Post Deleted Successfully", true);
    }
</script>